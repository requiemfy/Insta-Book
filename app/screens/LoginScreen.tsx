...
import { NavigationScreenProp, NavigationState, NavigationInjectedProps, withNavigation } from 'react-navigation';

class LoginScreen extends React.PureComponent<NavigationInjectedProps | any> {
  email: string;
  password: string;
  emailTextInput: typeof TextInput | any;
  passTextInput: typeof TextInput | any;
  state: { invalidCreds: boolean }; 
